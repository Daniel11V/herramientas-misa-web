...
export const testData: TDatabaseState = {
	authorList: {
		...
		"123458": {
			...
			email: "",
			photoUrl:
				"https://cdn.shopify.com/s/files/1/0023/8360/9916/files/Captura_de_pantalla_2020-11-23_a_las_14.59.22.png?v=1606139985&width=2048",
			creatorId: "111418653738749034139",
	...
	privateSongTitleList: {
		"1669864387705": {
			...
			labels: ["padre", "comunion", "meditacion"],
			annotations: "",
			pulse: "",
			tempo: "",
			level: {
	...
	publicSongTitleList: {
		"123": {
			...
			lyricStart:
				"En tormentas, en mi oscuridad, Infunde tu luz, trae la calma, Purifícame y lávame de aquello, que me aleja de ti",
			tone: "F",
		...
		"124": {
			...
			lyricIsPrivate: false,
			lyricStart:
				"Tu presencia es real, todo Dios en el altar, Seas bendito y alabado, Jesús sacramentado",
		...
		"125": {
			...
			lyricIsPrivate: false,
			lyricStart:
				"En la intimidad de tu presencia, Te rindo hoy mi ser y mi corazón, No hay lugar mejor, que ha tus pies Señor, En ti encuentro paz, encuentro amor.",
		...
		"1682512333508": {
			...
			lyricIsPrivate: false,
			lyricStart:
				"Siempre imaginé la felicidad ligada al poder y a la comodidad. Siempre imaginé la felicidad ligada a mis sueños cumplidos.",
		},
	},
	publicSongLyricList: {
		"123": {
